...
const Projects = () => {
  return (
    <div>
      <Nav />
      <div className="project-main-container first-container">
        <div className="project-container">
          <div className="project-sub-container">
            ...
            <div className="project-box">
              <p>
                <span className="highlight">개발 기간</span> - 2022.07.11 ~
                2022.07.29
              </p>
              <p>
                <span className="highlight">개발 인원</span> - 6명 (FE - 3명,
                React.js / BE - 3명, Node.js)
              </p>
              <Link
                href="https://github.com/happyeveryone96/justcode-5-2nd-dream-front"
                target="_blank"
              >
                <Image alt="GitHub" src={Github} className="github" />
              </Link>
              <p>
                <span className="highlight">사용 기술</span> - React.js,
                JavaScript, SCSS, Styled-Components, HTML
              </p>
              <p>
                <span className="highlight">주요 기능</span> - 로그인, 회원가입,
                카카오 로그인, 메인 페이지, SHOP 페이지, 마이 페이지, 제품 상세
                페이지
              </p>
              <p className="highlight">담당 기능</p>
      ...
      <div className="project-main-container">
        <div className="project-container">
          <div className="project-sub-container">
            <h1>RUSH</h1>
            <p className="highlight">LUSH를 모티브로 한 프로젝트</p>
            <div className="project-box">
              <p>
                <span className="highlight">개발 기간</span> - 2022-06-20 ~
                2022-07-08
              </p>
              <p>
                <span className="highlight">개발 인원</span> - 4명 (FullStack
                4명, React.js + Node.js)
              </p>
              <Link
              ...
              <p>
                <span className="highlight">주요 기능</span> - 로그인, 회원가입,
                메인 페이지, 제품 상세 페이지, 장바구니, 제품 리스트 페이지
              </p>
              <p className="highlight">담당 기능</p>
      ...
      <div className="project-main-container">
        <div className="project-container">
          <div className="project-sub-container">
            <h1>disCATch</h1>
            <p className="highlight">동네 고양이 돌봄 플랫폼</p>
            <div className="project-box">
              <p className="highlight">기획 의도</p>
              <p>
              ...
              <p>
                <span className="highlight">개발 기간</span> - 2021.09 ~ 2021.12
              </p>
              <p>
                <span className="highlight">개발 인원</span> - 4명 (FE - 2명,
                React.js / BE - 2명, Java Spring)
              </p>
              <Link
              ...
              <p>
                <span className="highlight">사용 기술</span> - React.js, Redux
                Toolkit, JavaScript, WebSocket, HTML, Styled-Components
              </p>
              <p>
                <span className="highlight">주요 기능</span> - 무한스크롤,
                토스트 팝업, 카카오맵, 카카오맵 검색, 커뮤니티, 이미지 업로드,
                실시간 채팅, 소셜 로그인
              </p>
              <p className="highlight">담당 기능</p>
      ...
      <div className="project-main-container">
        <div className="project-container">
          <div className="project-sub-container">
            <h1>UZik (우리들의 직업)</h1>
            <p className="highlight">직업 소개 서비스</p>
            <div className="project-box">
              <p>
              ...
              <p>
                <span className="highlight">개발 기간</span> - 2021.12.20 ~
                2022.01.03
              </p>
              <p className="highlight">개인 프로젝트</p>
              <Link
